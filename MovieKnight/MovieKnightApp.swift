...
let allPlatforms: [StreamingPlatform] = [
    ...
    .init(id: "disney",      key: "disney",      name: "Disney+",     logoAsset: "disney+",     accentColor: Color(red: 0.067, green: 0.235, blue: 0.812)),
    ...
    .init(id: "paramount",   key: "paramount",   name: "Paramount+",  logoAsset: "paramount+",  accentColor: Color(red: 0.000, green: 0.392, blue: 1.000)),
